...
<style>
    body {
        /* background-image: url('https://images.unsplash.com/photo-1622126807280-9b5b32b28e77?ixlib=rb-4.0.
		3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1160&q=80');
                ...
                <div class="modal-body">
                    ...
                    <form action="Lecture05ToDoApp.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="titleEditt" 
							name="titleEdit" aria-describedby="emailHelp">

                        </div>
                        <div class="form-floating">
                            <textarea class="form-control" placeholder="Leave a comment here" 
							name="desEdit" id="desEdit"></textarea>
        ...
        <div class="container mt-4 table-success">
            <table id="myTable" class="table table-success table-hover">
                ...
                <tbody>
					...
					id=" . $show['Id'] . ">Edit</button>
                    <button type='button' class='btn btn-danger  delete' 
					id=d" . $show['Id'] . ">Delete</button>       
                    </td>           
                    </tr>";
                    }
                    ?>
